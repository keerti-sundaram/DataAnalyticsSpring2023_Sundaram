...
fitimport <- randomForest(price ~ fuelType + numOfDoors + engineLocation, data = imports85, na.action = na.omit)
print(fitimport) # view results
importance(fitimport) # importance of each predictor
